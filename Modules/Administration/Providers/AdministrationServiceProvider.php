...
final class AdministrationServiceProvider extends ServiceProvider
{
    ...
    {
        foreach ([ConfigurationRegistry::class, ConfigurationCache::class, ConfigurationValidator::class, ConfigurationEngine::class, SecurityEngine::class, MonitoringEngine::class, AuditEngine::class, BackupEngine::class, RestoreEngine::class, IntegrationEngine::class, HealthCheckEngine::class, ModuleRegistry::class, SystemCapabilityRegistry::class, EnvironmentResolver::class, AdministrationEngine::class] as $service) {
