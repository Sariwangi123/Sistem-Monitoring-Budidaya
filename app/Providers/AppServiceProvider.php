...
use Modules\Notifications\Channels\ChannelResolver;
...
use Modules\Notifications\EventBus\InMemoryEventBus;
...
use Modules\Notifications\Resolvers\RecipientResolver;
...
final class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(EventBusInterface::class, InMemoryEventBus::class);
        $this->app->bind(RecipientResolverInterface::class, RecipientResolver::class);
        $this->app->bind(ChannelResolverInterface::class, ChannelResolver::class);
